...
public class Game 
	...
	public static void main(String[] args)   //Main 
		...
		for(k=0;k<20;k++)
		    {
			System.out.println("Enter the number of Pins knocked down in this Roll (Enter '0' for the second roll in case of a strike)");  //So that the extra roll doesn't count after a strike.
			pins = in.nextInt();  //Dynamically Accept the knocked down pins for every roll
